...
import com.danny.seckill.framework.log.enums.LogAlarmTypeEnum;
import com.danny.seckill.framework.log.enums.LogCategoryEnum;
import com.danny.seckill.framework.log.enums.MethodLogKeysEnum;
import com.danny.seckill.framework.log.enums.ResultTypeEnum;
...
import com.danny.seckill.framework.util.StringJsonHandler;
...
public class LogTraceAspect extends AbstractLog {
     ...
     * 举例：com.danny.seckill.service.impl.system.UserServiceImpl
     *
     * @param joinPoint
     * @return
     */
    ...
    private List<String> getDefaultIgnoreRequestClass() {
        List<String> defaultIIgnoreRequestClassList = new ArrayList<>();
